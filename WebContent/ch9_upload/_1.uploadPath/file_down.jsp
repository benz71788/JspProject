...
<%
	...
	/*
		Content-Type : 전송되는 Content가 어떤 유형인지 알려주는
			목적을 가지고 있습니다.
		text/html, image/png, application/octet-stream 등의
			값을 가집니다.
		Content-Type을 통해서 브라우저는 해당 데이터를 어떻게 처리해야 할 지
			판단할 수 있게 됩니다.
			예) - image/png: 브라우저는 해당 컨텐트를 이미지로써 간주하게 됩니다.
				- application/octet-stream: 미확인 Binary 정보를 의미하며,
					이 경우 브라우저는 파일을 다운로드하는 형태로 동작합니다.
				- text/javascript: 브라우저는 Content를 Javascript문서로 
					취급하게 됩니다.
	*/
	/*
	...
	*/
	...
	/*
		...
		- getBytes(캐리터셋) : 자바 내부에 관리되는 유니코드 문자열을
	...
	/*
		- Content-Disposition:
			...
			2) Content-Disposition:
				attachment: 브라우저는 해당 Content플 처리하지 않고,
						다운로드 하게 됩니다.
	*/
	...
	*/
	...
	try{
		...
		while((numRead = in.read(b, 0, b.length)) != -1){
			//바이트 배열 b의 0부터 numRead크기 만큼 브러우저로 출력
